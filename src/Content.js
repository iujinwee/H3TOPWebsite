...
const clans = {
    ...
    Bankai: {
        ...
        story: "The wild, fearless and mythical beast Bankai is a Japanese kitsune with mind-channelling abilities like Telekinesis. With sharp steel claws and a ring of black fur around its cunning eyes, Bankai’s appearance is certainly daunting and even the slightest glimpse of it in the woods has scared many travellers away. Bankai will stop at nothing to ensure survival, including manipulating his enemies and gaslighting them into doing what he wants. He was also blessed with the ability to breathe fire when he is in a rage, which has burned down entire towns and cities in the past . Currently, he resides in the kingdom of Borderland, where he has established his dominance and gathered respect from all the civilians. However, his latest threats are the 4 new beasts that have recently entered his kingdom and the land that he reigns - Akari, Chakra, Doku and Enji.",
        story2: "Driven by their hunger for power, they threaten to contest for the throne and gain control over the civilians. One challenge remains for Bankai - will he be able to ensure the loyalty of his people and overthrow his enemies?"
    },
    ...
    Doku: {
        ...
        story: "Our character is named “Doku” which means poisonous in Japanese. We decided to name our character, “Doku”, as it is fierce, reckless and a formidable force, just like the characters in “Alice in Borderland”. “Doku” is a powerful character that is ever-ready to overcome challenges with the snap of a finger. Using its poison and quick-thinking skills, its enemies simply stand no chance of surviving against “Doku”. In addition, the poker card that ties in with our character is symbolic of the risks “Doku” is ready to take in order to gain victory and it ties in well to the idea of poker cards used in the series “Alice In Borderland”."
    },
