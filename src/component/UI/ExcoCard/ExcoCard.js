  ...
  return (
    ...
    >
      <ReactCardFlip isFlipped={hover} flipDirection="horizontal">
        ...
        >
          <img
            className="rounded-2xl border-4 border-[rgb(0,0,0)] shadow-[0_35px_60px_-20px_rgba(0,0,0,0.6)]"
            src={props.image}
        ...
        <Container className="flex flex-col object-contain m-auto p-0">
          ...
          >
            ...
            />
            <figcaption
              className="absolute m-auto text-center top-18 font-black text-red-50 px-3"
              onMouseLeave={onLeaveHandler}
            >
